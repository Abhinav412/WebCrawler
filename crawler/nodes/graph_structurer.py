...
_PROPERTY_PREDICATES = {"LOCATED_IN","HEADQUARTERED_IN","HAS_FUNDING","FUNDING_AMOUNT","FOUNDED_IN","HAS_PRICING","PRICING_MODEL","HAS_COMMUNITY_SIZE","HAS_DIFFICULTY_LEVEL","WRITTEN_IN","SUPPORTS_LANGUAGE","HAS_PROPERTY"}
